<?php
	...
	$CallbackURL = $systemUrl . '/modules/gateways/callback/zp_sadad.php?invoiceid='. $_POST['invoiceid'] .'&Amount='. $Amount;
	try {
	...
	if($result->Status == 100){ 
		...
		$url = "https://$mirror.zarinpal.com/pg/StartPay/$vahabid/Sad";
		redirect($url);
	} else {
